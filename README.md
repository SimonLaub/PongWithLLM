...
<br>
I.e. After having previously worked on a Car game, <br>
(See project code here: <a href="https://github.com/SimonLaub/CarGame">Car Game</a>)<br>
it is now time to work on (with a little help from ChatGPT) <br>a Pong and a Shooter game.<br>
...
<br>
<img src="Pics/PongDump2.jpg" alt="Pong game" width="400"><br>
...
Again, pretty good, and the code runs after only a few minor (manual) corrections. <br>
<br>
